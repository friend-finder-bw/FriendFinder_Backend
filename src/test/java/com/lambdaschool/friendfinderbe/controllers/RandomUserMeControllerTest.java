...
public class RandomUserMeControllerTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        arrayList.add(new RandomUserMe("jurema",
        "rodrigues",
        "miss",
        "female",
        "69",
        "1950-05-26T16:40:14Z",
        "Brazil",
        "Movies",
        "jurema.rodrigues@example.com",
        "(87) 8384-0912",
        "(64) 7991-3560",
        "1264 rua primeiro de maio ",
        "porto velho",
        "tocantins",
        "30621",
        "-3:30",
        ...
        arrayList.add(new RandomUserMe("léane",
        "moulin",
        "mrs",
        "female",
        "58",
        "1961-03-22T03:59:35Z",
        "France",
        "Movies",
        "léane.moulin@example.com",
        "03-59-93-00-06",
        "06-14-54-77-96",
        "4972 rue des ecrivains",
        "marseille",
        "haute-marne",
        "69833",
        "+7:00",
        ...
        arrayList.add(new RandomUserMe("bella",
        "patel",
        "miss",
        "female",
        "25",
        "1994-05-26T11:28:32Z",
        "New Zealand",
        "Computers",
        "bella.patel@example.com",
        "(120)-450-0838",
        "(481)-097-1881",
        "1813 castle street",
        "hamilton",
    ...
    public void getProfiles() throws Exception
    {
        ...
        Mockito.when(externalAccess.connectAndRetrieveJson("?seed=ffbe&results=3")).thenReturn(arrayList);
